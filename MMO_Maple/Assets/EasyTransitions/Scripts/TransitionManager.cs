...
namespace EasyTransition
{
    ...
    {        
        ...
        /// <param name="startDelay">The delay before the transition starts.</param>
        public void Transition(Define.Scene type, TransitionSettings transition, float startDelay, Action ac = null)
        {
            if (transition == null || runningTransition)
            {
                Debug.LogError("You have to assing a transition.");
            ...
            runningTransition = true;
            StartCoroutine(Timer(type, startDelay, transition, ac));
        }
        /// <summary>
        /// Loads the new Scene with a transition.
        /// </summary>
        ...
        IEnumerator Timer(Define.Scene type, float startDelay, TransitionSettings transitionSettings, Action ac = null)
        {
